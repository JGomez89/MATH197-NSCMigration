...
FolderName2 = '/Figures/Cancer/';       %Save plots to this folder when there is cancer (Must pre-exist)global n_seeds Finaltimestep CONVERT2MICRON coh_limit chmtx_limit d_w cancer_size  cancer_center ...
    has_cancer  modelNum modelType alpha4chmtx beta4dist chemo_sensitivity d_g FolderName1 FolderName2 
